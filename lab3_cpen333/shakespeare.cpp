...
int main() {
	...
	std::vector<std::string> filenames = {
		"data/shakespeare_alls_well.txt",
		"data/shakespeare_antony_cleopatra.txt",
		"data/shakespeare_as_you_like_it.txt",
		"data/shakespeare_comedy_of_errors.txt",
		"data/shakespeare_coriolanus.txt",
		"data/shakespeare_cymbeline.txt",
		"data/shakespeare_gentlemen_of_verona.txt",
		"data/shakespeare_hamlet.txt",
		"data/shakespeare_julius_caesar.txt",
		"data/shakespeare_king_henry_IV_first",
		"data/shakespeare_king_henry_IV_second.txt",
		"data/shakespeare_king_henry_V.txt",
		"data/shakespeare_king_henry_VI_first.txt",
		"data/shakespeare_king_henry_VI_second.txt",
		"data/shakespeare_king_henry_VI_third.txt",
		"data/shakespeare_king_henry_VIII.txt",
		"data/shakespeare_king_john.txt",
		"data/shakespeare_king_lear.txt",
		"data/shakespeare_king_richard_II.txt",
		"data/shakespeare_king_richard_III.txt",
		"data/shakespeare_lovers_complaint.txt",
		"data/shakespeare_loves_labours_lost.txt",
		"data/shakespeare_macbeth.txt",
		"data/shakespeare_measure_for_measure.txt",
		...
		"data/shakespeare_romeo_and_juliet_prologue.txt",
		"data/shakespeare_taming_of_the_shrew.txt",
		"data/shakespeare_tempest.txt",
		"data/shakespeare_timon_of_athens.txt",
		"data/shakespeare_titus_andronicus.txt",
		"data/shakespeare_troilus_and_cressida.txt",
		"data/shakespeare_twelfth_night.txt",
		"data/shakespeare_winters_tale.txt",
		"data/shakespeare_wives_of_windsor.txt"
	};
